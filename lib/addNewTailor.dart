...
class AddNewTailor extends StatefulWidget {
  const AddNewTailor({super.key});

  @override
  State<AddNewTailor> createState() => _AddNewTailorState();
}

class _AddNewTailorState extends State<AddNewTailor> {
  ...
  Future<void> addShop() async{
    ...
    try{
      await FirebaseFirestore.instance.collection("Tailor").add({
        'tailorName':shopName.text,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Add New Tailor"),backgroundColor: Colors.amber,),
      body: Padding(
